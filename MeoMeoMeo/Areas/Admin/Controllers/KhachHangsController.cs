...
namespace MeoMeoMeo.Areas.Admin.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        {
            var khachHangs = db.KhachHangs.Include(k => k.UserRole);
        ...
        {
            ViewBag.MaUR = new SelectList(db.UserRoles, "MaUR", "UserRole1");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKH,TenKH,Sdt,Diachi,TenDN,MK,MaUR")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
